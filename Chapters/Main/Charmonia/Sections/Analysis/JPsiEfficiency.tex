...
To apply the \tnp corrections, the \JPsi-meson efficiency is recomputed by weighing each dimuon candidate  with the \tnp-correction weights for each muon to trigger, according to:
